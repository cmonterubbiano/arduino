...
char	colonna[20];
char	risposta[20];
int	accensione =15;					//elementi -1 da controllare prima del decorso normale

int	elementi_allarme =15;			//elementi -1 da controllare per allarme
					...
					if (accensione >5)
					{
						switch(accensione)
						{
							...
							case 10:
								...
								break;
							case 9:
								umi_temp[0] =min_temp[0] =atof(appo);
								break;
							case 8:
								umi_temp[1] =min_temp[1] =atof(appo);
								break;
							case 7:
								uma_temp[0] =max_temp[0] =atof(appo);
								break;
							case 6:
								uma_temp[1] =max_temp[1] =atof(appo);
								break;
						}								
					}
