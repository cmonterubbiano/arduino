...
#include "DHT.h"
#define DHT1PIN 7  // inserire il numero del pin a cui collegato sensore => in questo caso sostituisci il 2
#define DHT2PIN 8  //  come sopra ma sostituire il 3
#define DHT3PIN 9  //  come sopra ma sostituire il 3
